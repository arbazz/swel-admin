                ...
                >
                    ...
                    <Column className={css(styles.menuItemList)}>
                        ...
                        <MenuItemComponent
                            title="Banner"
                            icon={IconTickets}
                            onClick={() => onItemClicked('Banner')}
                            active={selectedItem === 'Banner'}
                        />
                        <MenuItemComponent
                            title="Album"
                            icon={IconIdeas}
                            onClick={() => onItemClicked('Album')}
                            active={selectedItem === 'Album'}
                        />
                        <MenuItemComponent
                            title="Song"
                            icon={IconContacts}
                            onClick={() => onItemClicked('Song')}
                            active={selectedItem === 'Song'}
                        />
                        <MenuItemComponent
                            title="Artist"
                            icon={IconAgents}
                            onClick={() => onItemClicked('Artist')}
                            active={selectedItem === 'Artist'}
                        />
                        <MenuItemComponent
                            title="Video"
                            icon={IconArticles}
                            onClick={() => onItemClicked('Video')}
                            active={selectedItem === 'Video'}
                        />
